/datum/admins/Topic(href, href_list)
	...
	if(href_list["makeAntag"])
		...
		switch(href_list["simplemake"])
			...
			if("praetorian")		M.change_mob_type( /mob/living/carbon/alien/humanoid/praetorian , null, null, delmob )
			if("ravager")			M.change_mob_type( /mob/living/carbon/alien/humanoid/ravager , null, null, delmob )
			if("spitter")			M.change_mob_type( /mob/living/carbon/alien/humanoid/spitter , null, null, delmob )
			if("runner")			M.change_mob_type( /mob/living/carbon/alien/humanoid/runner , null, null, delmob )
			...
			if("hivelord")			M.change_mob_type( /mob/living/carbon/alien/humanoid/hivelord , null, null, delmob )
			if("carrier")			M.change_mob_type( /mob/living/carbon/alien/humanoid/carrier , null, null, delmob )
